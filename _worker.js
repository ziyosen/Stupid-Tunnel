...
<head>
    ...
    margin: 0;
    padding: 0;
    font-family: 'Georgia', serif; /* Mengganti font Orbitron ke Georgia untuk kesan vintage */
    color: #f0e6d2; /* Warna teks lebih lembut */
    background-color: #2e2e2e; /* Latar belakang gelap dengan nuansa vintage */
    display: flex;
    align-items: center;
...
.container {
    ...
    width: 100%;
    margin: 3px;
    background: rgba(60, 60, 60, 0.8); /* Ganti latar belakang menjadi lebih gelap */
    ...
    max-height: 100vh;
    border-radius: 15px;
    box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.6); /* Menambahkan bayangan lembut untuk kesan klasik */
}
...
.header h1 {
    font-size: 42px;
    color: #f0e6d2; /* Warna teks yang lebih netral */
    background: none; /* Hilangkan efek gradient pelangi */
    margin: 0;
    font-weight: bold;
    text-transform: uppercase;
    letter-spacing: 3px;
    text-shadow: 2px 2px 6px rgba(0, 0, 0, 0.6); /* Efek bayangan lembut */
}
...
.nav-buttons .button {
    border: 2px solid #bfa66d; /* Menggunakan warna vintage untuk border */
    color: #f0e6d2;
    padding: 6px 12px;
    font-size: 18px;
    border-radius: 4px;
    ...
    background: #3b3b3b;
    box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.3); /* Menambahkan bayangan lembut pada tombol */
}

.nav-buttons .button:hover {
    transform: scale(1.05);
    background-color: #6f4f1e; /* Ganti warna background saat hover */
    color: #fff;
}
...
.config-section {
    ...
    margin: 10px;
    border-radius: 10px;
    border: 2px solid #bfa66d; /* Warna border lebih vintage */
...
.config {
    ...
    border-image: linear-gradient(45deg, #bfa66d, #ffcc66) 1;
    color: #e0e0e0;
...
.button {
    ...
    letter-spacing: 1.5px;
    margin-right: 4px;
    background: #6f4f1e; /* Warna vintage untuk tombol */
}

.button:hover {
    background-color: #bfa66d; /* Warna lebih terang saat hover */
    color: #fff;
    transform: scale(1.0);
}
...
.config-divider {
    border: none;
    height: 1px;
    background: #bfa66d; /* Warna pembatas vintage */
    margin: 20px 0;
}
...
.watermark a {
    color: #bfa66d; /* Warna vintage untuk watermark */
    text-decoration: none;
    font-weight: bold;
}

.watermark a:hover {
    color: #f0e6d2; /* Warna hover untuk watermark */
}
